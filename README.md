...
Temperature, utilization, VRAM usage
...
Training time and epoch progress

Mining Monitoring

kern --mining

Algorithm detection (RandomX, Ethash, SHA-256)

Hashrate and share statistics

Power efficiency calculations

Temperature and revenue estimation
...
GET /api/mining	Mining activity	{"algorithm": "Ethash", "hashrate": "85.2 MH/s"}
